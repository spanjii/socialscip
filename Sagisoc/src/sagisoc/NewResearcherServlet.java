...
public class NewResearcherServlet extends HttpServlet {
		...
		String mail = req.getParameter("mail");		
			...
			try {
				...
				if (doRequest == false) {
					...
					resp.sendRedirect("/formnewresearcher.jsp?logout="
							+ URLEncoder.encode(logout, "UTF-8") + "&alreadyRequested=true");
				}
